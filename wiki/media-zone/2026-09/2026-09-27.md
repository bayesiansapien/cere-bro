...
- **Minimal harness, round two.** dair.ai and Omar Sanseviero amplify an MIT CSAIL paper making the same keep-it-small argument, plus a report on faster agent memory ([@dair_ai](https://x.com/dair_ai/status/2103827476959129773)).
