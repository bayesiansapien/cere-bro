...
- **Feed note:** no new saved posts today, LinkedIn returned zero organic posts, and YouTube surfaced no AI or tech videos, so this is an X-feed-only read.
...
- **Why that matters right now.** A model upgrade is exactly when accumulated instructions turn into liabilities, and today's Astra prompting guidance says old `AGENTS.md` rules now fight the model. Nobody has published a pruning criterion.

<div class="mz-links">

[@rohanpaul_ai](https://x.com/rohanpaul_ai) · [@sleepy0x13](https://x.com/sleepy0x13) · [@ryanlpeterman](https://x.com/ryanlpeterman) · [@_philschmid](https://x.com/_philschmid)
