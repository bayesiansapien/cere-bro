...
<li><span class="verb track">Track</span><strong>Semiconductor Week 34.</strong> Micron plans a $10B research hub; Cerebras CS-4 packs three wafer-scale engines for 750 PFLOPS; NVIDIA backs 4.25 GW of initial AI capacity for OpenAI; Marvell's Google warrant ties to up to $120B in custom silicon. The compute-allocation war keeps escalating. <a href="https://thesemiconductornewsletter.substack.com/p/week-34-2026">Newsletter</a>.</li>
<li><span class="verb skim">Skim</span><strong>The harness explosion.</strong> Your #1 saved theme is having a moment: Apodex 1.1 (145 upvotes) reaches the frontier band with a 35B model via a shared execution harness; Prime Agent lifts ARC-AGI-3 from 30% to 95.5%; Task-CoEvolve cuts harness-tuning cost 80%. <a href="https://arxiv.org/abs/2608.23283">Apodex</a> · <a href="../../agentic-systems/agent-harness-engineering.md">concept page</a>.</li>
</ol>
</div>
