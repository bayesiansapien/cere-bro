...
<li><span class="verb skim">Skim</span><strong>Harness search gets a budget, answering the number NVIDIA published two days ago.</strong> If 39 of 40 proposed harness edits are waste, stop evaluating uniformly. COBRA-Skills uses a contextual bandit to pick which candidates are worth an execution, at 55-58% lower optimization cost. Your biggest saved theme, now with a cost curve. <a href="http://arxiv.org/abs/2609.11682">COBRA-Skills</a> · <a href="http://arxiv.org/abs/2609.09646">RobustSGPO</a> · <a href="../../agentic-systems/2026-09-13-cobra-skills-robustsgpo-harness-search.md">Wiki</a></li>
