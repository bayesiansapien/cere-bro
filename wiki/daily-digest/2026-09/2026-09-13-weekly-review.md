...
5. **Intelligence per Watt (09-11, Stanford/Together)** — routing priced in joules, the strongest measured version of the routing thesis, 60 to 80% energy and cost savings. [Wiki](../../ai-routing/2026-09-11-intelligence-per-watt-local-cloud-routing.md)
