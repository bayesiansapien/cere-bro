...
<li><span class="verb track">Track</span><strong>"Catastrophic remembering" in CLAUDE.md files.</strong> Your saved-reading trail's hottest theme is loop and harness engineering, at 13 items, and this is the first paper to measure the failure mode you have been living with. Across <strong>247,694 instructions in 1,867 GitHub repositories</strong>, agent instruction files only ratchet up: a rule is cheap to add, and nobody dares delete one because nobody remembers what it was for. Track it because the research gap is well-posed and unclaimed: <strong>no published method measures whether an instruction in a CLAUDE.md is still load-bearing</strong>, which is exactly the deletion criterion the ratchet is missing, and the dataset to test it on is public. <a href="https://x.com/rohanpaul_ai">via @rohanpaul_ai</a> · <a href="../../agentic-systems/agent-harness-engineering.md">harness page</a>.</li>
</ol>
</div>
