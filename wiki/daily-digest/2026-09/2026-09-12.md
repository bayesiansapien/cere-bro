...
- **25 Fields Medalists including Terence Tao signed a declaration** that benchmark-driven AI mathematics damages the field's transmission and attribution mechanisms ([mathandai.org](https://mathandai.org/)).
...
- **The Mathematical AI Safety Institute launched**, aiming to formally prove properties of AI systems rather than test them empirically ([The Decoder](https://the-decoder.com/the-mathematical-ai-safety-institute-wants-to-prove-ai-safety/)).
...
- **Tencent-backed Enflame tripled on its trading debut** as China pushes domestic AI chip supply ([The Information](https://www.theinformation.com/articles/tencent-backed-enflame-triples-debut-china-pushes)).
