...
- **Kimi K3 sends shockwaves and fuels a tech selloff**: The Information reports Moonshot's frontier-level coding on some benchmarks reignited the "Chinese open-source has closed the gap" debate; the Nasdaq-100 selloff was partly attributed to the release ([The Information](https://www.theinformation.com/articles/moonshot-ai-s-new-kimi-k3-challenges-u-s-frontier-models)).
- **Databricks valued at $188B**: new Coatue-led round, a 40% jump from December, as AI data-infrastructure demand surges ([The Information](https://www.theinformation.com/articles/databricks-valued-at-188-billion-as-ai-demand-surges)).
- **China memory-chipmaker CXMT seeks $8.6B Shanghai IPO**: set to be the biggest domestic tech listing, directly relevant to the HBM/memory supply chain ([The Information](https://www.theinformation.com/articles/china-memory-chipmaker-cxmt-seeks-8-6-billion-in-shanghai-ipo)).
- **OpenRouter fields multibillion-dollar takeover interest**: the model-access aggregator (last valued $1.3B) discussed a sale at a steep premium, a signal that the routing/access layer is strategically valuable ([The Information](https://www.theinformation.com/articles/startup-openrouter-fields-multibillion-dollar-takeover-interest)).
- **Xi calls for "open source, open collaboration"**: China's leader endorsed open AI development at the Shanghai World AI Conference, a state-level counter to the US open-weights restriction debate ([The Information](https://www.theinformation.com/articles/chinese-leader-xi-calls-for-open-source-open-collaboration-in-shanghai-ai-conference)).
- **Meta in talks to rent excess compute to Anthropic**: Zuckerberg's plan to sell surplus data-center capacity may find its first big customer in Anthropic; Meta also moving to hire a top AWS executive to run it ([The Decoder](https://the-decoder.com/zuckerbergs-plan-to-sell-excess-ai-compute-could-finds-its-first-big-customer-in-anthropic/)).
