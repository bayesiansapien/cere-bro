...
- **Anthropic's Claude voice mode now runs on its most capable model** ([The Decoder](https://the-decoder.com/claude-s-voice-mode-now-runs-on-anthropic-s-most-capabl/)).
...
- **Poolside releases Laguna S-2.1**, a small open-weight coding model ([The Decoder](https://the-decoder.com/poolside-s-laguna-s-2-1-is-a-small-open-weight-coding-m/)).
