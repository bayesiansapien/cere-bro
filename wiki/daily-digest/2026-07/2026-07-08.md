...
- **Claude memory tool goes GA**: Fable 5's memory tool is generally available on the Messages API. One lesson per file, update existing notes, delete proven-wrong ones. Memory poisoning documented as an official attack class by Anthropic's security team ([Agentic AI](https://kenhuangus.substack.com/p/claude-fable-5-part-3-memory-engineering)).
