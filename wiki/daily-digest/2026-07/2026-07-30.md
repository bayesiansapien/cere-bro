...
- **Microsoft revenue rose 18% to $90 billion**, with AI sales growth offset by declines in Xbox and Windows devices ([The Information](https://www.theinformation.com/briefings/microsofts-rising-ai-sales-fail-boost-overall-growth-june-quarter)).
- **Zuckerberg signalled Meta may rent out excess compute capacity**, which would make it a seller in the market where it is currently the most aggressive buyer ([The Information](https://www.theinformation.com/briefings/meta-shares-fall-profits-drop)).
- **Anthropic shipped CryptanalysisBench** alongside the Mythos cipher work, to track how fast models are getting at breaking encryption ([Anthropic](https://www.anthropic.com/research/discovering-cryptographic-weaknesses)).
- **Shared Claude chats were indexed by Google** after a missing noindex tag on link sharing, briefly exposing crypto wallet keys and legal documents ([The Decoder](https://the-decoder.com/shared-claude-chats-were-reportedly-showing-up-in-search-engines/)).
- **Gary Marcus argues Amodei has burned his accumulated goodwill**, pointing at a call to lock down distillation issued the same week Anthropic was reported destroying rare books in bulk to distill them ([Marcus on AI](https://garymarcus.substack.com/p/dario-takes-it-on-the-chin)).
- **Altman walked back his AI-CEO vision** on Invest Like the Best, saying people still demand human accountability, and endorsed the pacing petition ([YouTube](https://www.youtube.com/watch?v=XDB5beon4DY)).
- **OpenAI issued Codex quota resets plus an 18% efficiency gain** after GPT-5.6 Sol's parallel execution and extended reasoning loops drained power users' quotas ([@thsottiaux](https://x.com/thsottiaux/status/2082317452755751098)).
- **OpenAI shipped GPT-Live-Transcribe and GPT-Transcribe**, contextual speech models using surrounding text and domain keywords to halve Whisper's multilingual error rates ([@OpenAIDevs](https://x.com/OpenAIDevs/status/2082201169443905798)).
- **43.5% of ChatGPT work prompts involve task crossover**, with small-business staff auditing contracts and debugging sites outside their own expertise ([Axios](https://www.axios.com/2026/07/27/openai-chatgpt-work-specialists)).
- **Tesla produced its 10 millionth vehicle** at Fremont, six years after its millionth ([@Tesla](https://x.com/Tesla/status/2082707648148099363)).

**Funding, valuations, and compute deals**

- **Core Automation launched**, founded by Jerry Tworek, who ran OpenAI's reasoning team, and Rohan Anil, a Gemini pre-training lead, on the thesis that models cannot keep learning once they leave the lab ([@MillionInt](https://x.com/MillionInt/status/2082550620926665182)).
- **OpenAI announced free frontier-model access for 100,000 scientists, mathematicians and engineers through 2027** ([via @Polymarket](https://x.com/Polymarket/status/2082518264387895491)).
- **Amazon is hiring 11,000 interns and new college graduates this year**, per AWS CEO Matt Garman ([@mattsgarman](https://x.com/mattsgarman/status/2082552233418166630)).
