...
- **Elon put dates on the next two Grok models**: 4.6 around August 7 at 1.5T parameters with improved supervised and RL post-training, then 4.7 at 2.1T a few weeks later, slower to serve but with better token efficiency ([@elonmusk](https://x.com/elonmusk/status/2082123925283041545)).
