...
- **Demis Hassabis endorses preflight safety testing**: the DeepMind CEO publicly backed mandatory pre-deployment safety evaluation for frontier AI, a notable position from a frontier-lab head ([Marcus on AI](https://garymarcus.substack.com/)).
- **State of AI Safety in China (2026) released**: a full report plus interactive companion site mapping China's AI-safety landscape, useful context for the open-weights restriction debate ([AI Safety China](https://aisafetychina.substack.com/)).
- **"Loop engineering" enters the mainstream vocabulary**: Pragmatic Engineer unpacks the term for agent loops, the same concept Ken Huang's Fable 5 series built on, now reaching a broader engineering audience ([Pragmatic Engineer](https://newsletter.pragmaticengineer.com/)).
- **xAI uploads codebases to Prime Intellect verifiers**: plus Sakana's "smart bricks," per TLDR AI ([TLDR AI](https://tldr.tech/ai)).
