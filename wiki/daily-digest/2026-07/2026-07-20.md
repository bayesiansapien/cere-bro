...
- **Alibaba answers with Qwen 3.8 (2.4T)**: open-weight multimodal, "second only to Fable 5" per the Qwen team ([The Decoder](https://the-decoder.com/alibabas-qwen-takes-on-kimi-k3-with-open-weight-qwen-3-8/)).
