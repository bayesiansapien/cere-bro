...
- **Gary Marcus: Washington made a mess** — calls the Fable shutdown arbitrary and possibly corruption-adjacent (it helped OpenAI backers), but says it killed zero-regulation absolutism and urges an independent AI agency ([Marcus on AI](https://garymarcus.substack.com/p/what-washington-must-do)).
