...
**It is the research twin of what industry shipped the same week.** [DeepSeek open-sourced Harness v0.1 (08-14)](../ai-industry/2026-08-14-deepseek-harness-v01-cache-repricing.md) under MIT with multiple swappable harness modes, and [Grok 4.6 (08-13)](../ai-industry/2026-08-13-grok-4-6-step-efficiency.md) cut agent workflows from 103 steps to 53 after tuning its own harness. Research is now evolving harnesses automatically while industry is shipping them as products, in the same seven-day window.
