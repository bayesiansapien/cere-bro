...
- 2026-06-04 — Scaling-parametrization for sparse/efficient architectures continues: [Gated Delta Networks μP](../inference-efficiency/2026-06-04-gated-delta-networks-mup.md) extends the closed-form hyperparameter-transfer programme from MoE ([MoE-μP, 05-17](2026-05-17-moe-mup-maximally-scale-stable-parameterization.md)) to gated linear attention, and [Marin's open MoE recipe](../inference-efficiency/2026-06-04-marin-moe-pretraining-speedup.md) reports the empirical dense→MoE speedup ledger (6.7x theoretical / 3.6x realized). "Derive the scaling rule once, never re-sweep at target scale" now spans two architecture families in three weeks.
