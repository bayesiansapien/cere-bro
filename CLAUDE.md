...
Do not start writing the digest until all five sources have been read. If a source directory has no file for the target date, note it explicitly and use the most recent available file from that source.
